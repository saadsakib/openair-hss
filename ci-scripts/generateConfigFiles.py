...
class hssConfigGen():
	...
	def GenerateHssConfigurer(self):
		...
		if not self.is_home:
			...
			hssFile.write('./data_provisioning_mme --id 4 --mme-identity mme4.$MY_REALM --realm $MY_REALM --ue-reachability 1 --truncate False  --verbose True -C $Cassandra_Server_IP\n')
